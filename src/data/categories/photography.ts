...
export const photographyCategory: Category = {
  id: "photography",
  name: "Photography",
  ...
  page_content: `# Creating Educational Photography Content
...
Photography content offers opportunities to share technical expertise while inspiring artistic growth and building communities of visual storytellers passionate about creating compelling images.`,
  slug: "photography",
  ideas: [
    { id: 90, title: "Creating a Photo Story", description: "Tell a complete story using only photographs", tags: ["photography", "storytelling", "visual"] },
