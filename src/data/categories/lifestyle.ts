...
export const lifestyleCategory: Category = {
  ...
  page_content: `# Lifestyle YouTube Content Ideas: Authentic Personal Storytelling

Lifestyle content on YouTube encompasses the personal, authentic side of content creation. This category thrives on genuine connections between creators and viewers, offering insights into daily life, personal growth, and individual journeys that inspire and motivate audiences.
...
Lifestyle content offers unique opportunities to build meaningful relationships with your audience while sharing your personal journey. Focus on topics you're genuinely passionate about, as authentic enthusiasm is what draws viewers to lifestyle content and keeps them engaged over time.`,
  slug: "lifestyle",
  ideas: [
    { id: 3, title: "Trying Viral TikTok Life Hacks", description: "Test popular life hacks from TikTok to see if they actually work", tags: ["tiktok", "lifehacks", "testing"] },
    { id: 9, title: "Surprising My Best Friend", description: "Plan and execute an amazing surprise for your best friend", tags: ["friendship", "surprise", "wholesome"] },
    { id: 11, title: "Day in My Life: Student Edition", description: "Show what a typical day looks like as a student", tags: ["student", "daily", "routine"] },
    { id: 23, title: "Morning vs Night Person Test", description: "Test whether you're actually a morning or night person", tags: ["lifestyle", "sleep", "routine"] },
    { id: 26, title: "Surprising Strangers with Kindness", description: "Perform random acts of kindness for strangers", tags: ["kindness", "wholesome", "social"] },
    { id: 36, title: "Home Spa Day DIY", description: "Create a relaxing spa experience at home", tags: ["spa", "relaxation", "selfcare"] },
    { id: 59, title: "Extreme Organizing Challenge", description: "Organize and declutter every space in your home", tags: ["organizing", "declutter", "lifestyle"] },
    { id: 61, title: "Creating a Time Capsule", description: "Make a time capsule to open in 10-20 years", tags: ["timecapsule", "memories", "future"] },
    { id: 87, title: "Testing Natural Cleaning Products", description: "Make and test cleaning products using natural ingredients", tags: ["cleaning", "natural", "diy"] },
    { id: 100, title: "Building the Ultimate Study Space", description: "Design and create the perfect environment for learning", tags: ["study", "productivity", "design"] }
  ]
};
