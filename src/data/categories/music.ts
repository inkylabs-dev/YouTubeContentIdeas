...
export const musicCategory: Category = {
  id: "music",
  name: "Music",
  ...
  page_content: `# Music Content on YouTube: Celebrating Musical Expression
...
Music content offers opportunities to share your musical gifts, educate others, and build communities around the universal language of music.`,
  slug: "music",
  ideas: [
    { id: 50, title: "Creating the Perfect Playlist", description: "Curate playlists for different moods and activities", tags: ["music", "playlist", "curation"] },
    { id: 57, title: "Making Music With Household Items", description: "Create instruments and music using everyday objects", tags: ["music", "diy", "creative"] },
