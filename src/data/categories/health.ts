...
export const healthCategory: Category = {
  ...
  page_content: `# Health and Wellness YouTube Content: Empowering Healthy Living

Health and wellness content on YouTube serves viewers seeking to improve their physical and mental well-being. This category combines educational value with practical advice, making it essential for creators passionate about helping others live healthier lives.

## The Impact of Health Content

Health videos perform well because people actively search for solutions to health concerns and wellness goals. However, this category requires careful attention to accuracy and responsible messaging, as viewers often rely on this content for health decisions.
...
Health content offers opportunities to make a meaningful positive impact on viewers' lives while building a community around wellness and healthy living.`,
  slug: "health",
  ideas: [
    { id: 4, title: "What I Eat in a Day (Healthy Edition)", description: "Show your daily meals focusing on healthy, nutritious choices", tags: ["health", "food", "nutrition"] },
    { id: 75, title: "Testing Sleep Hacks", description: "Try different techniques to improve sleep quality", tags: ["sleep", "health", "wellness"] },
    { id: 77, title: "Trying Every Smoothie Combination", description: "Experiment with different fruit and vegetable smoothies", tags: ["smoothie", "health", "nutrition"] }
  ]
};
