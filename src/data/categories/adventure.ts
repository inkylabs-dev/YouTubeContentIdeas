...
export const adventureCategory: Category = {
  id: "adventure",
  name: "Adventure",
  ...
  page_content: `# Creating Exciting Adventure Content
...
Adventure content offers opportunities to inspire exploration while sharing outdoor knowledge that helps others safely pursue their own adventure goals.`,
  slug: "adventure",
  ideas: [
    { id: 29, title: "Exploring Abandoned Places", description: "Safely explore and document abandoned buildings or areas", tags: ["abandoned", "exploration", "urban"] },
    { id: 45, title: "Camping in My Backyard", description: "Set up a complete camping experience in your own backyard", tags: ["camping", "outdoor", "backyard"] },
    { id: 56, title: "Trying Every Transportation Method", description: "Use different ways to get around your city for a day", tags: ["transportation", "adventure", "city"] }
  ]
};
