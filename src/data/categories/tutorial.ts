...
export const tutorialCategory: Category = {
  id: "tutorial",
  name: "Tutorial",
...
Tutorial content on YouTube serves viewers seeking to learn new skills, solve problems, or understand complex topics. This category offers opportunities to establish expertise while providing genuine value to audiences.
