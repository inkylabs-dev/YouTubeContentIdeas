...
export const wellnessCategory: Category = {
  id: "wellness",
  name: "Wellness",
  ...
  page_content: `# Creating Wellness Content for Mental Health
...
Wellness content offers opportunities to make positive impacts on viewers' mental health while building communities focused on holistic well-being.`,
  slug: "wellness",
  ideas: [
    { id: 79, title: "Testing Meditation Apps", description: "Try different meditation apps and compare benefits", tags: ["meditation", "wellness", "apps"] }
  ]
};
