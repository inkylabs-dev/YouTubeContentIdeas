...
export const animalCategory: Category = {
  id: "animal",
  name: "Animal",
  ...
  page_content: `# Animal Content on YouTube: Connecting with Animal Lovers

Animal content on YouTube appeals to pet owners, wildlife enthusiasts, and anyone who enjoys animal behavior and care information. This category offers opportunities for both education and entertainment.
