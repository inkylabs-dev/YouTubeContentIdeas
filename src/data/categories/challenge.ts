...
export const challengeCategory: Category = {
  id: "challenge",
  name: "Challenge",
  ...
  page_content: `# Creating Engaging Challenge Content
...
Challenge content offers opportunities to inspire audiences while creating highly engaging, shareable content that can start trends and build communities around personal growth and achievement.`,
  slug: "challenge",
  ideas: [
    { id: 1, title: "24 Hours in [Your City] Challenge", description: "Explore your city for 24 hours straight, trying new places and activities", tags: ["travel", "local", "challenge"] },
    ...
    { id: 19, title: "Extreme Budget Challenge", description: "Live on an extremely tight budget for a week", tags: ["budget", "challenge", "finance"] },
    { id: 25, title: "Technology Detox Challenge", description: "Give up all technology for 24-48 hours", tags: ["technology", "detox", "challenge"] },
    { id: 30, title: "Speed Running Life Tasks", description: "Complete everyday tasks as quickly as possible", tags: ["speed", "challenge", "efficiency"] },
    { id: 32, title: "Building a Fort Challenge", description: "Create the ultimate blanket fort or treehouse", tags: ["building", "fort", "fun"] },
    { id: 41, title: "Day as a Different Decade", description: "Live a full day as if you're in the 1950s, 60s, 70s, etc.", tags: ["vintage", "roleplay", "history"] },
