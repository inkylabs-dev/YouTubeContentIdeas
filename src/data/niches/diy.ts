...
export const diyNiche: Niche = {
  ...
  page_content: `# DIY YouTube Content Ideas: Creative Projects That Captivate Audiences
...
DIY content offers unlimited potential for creativity and audience engagement. Start with projects you're passionate about, and your enthusiasm will naturally translate into compelling videos that inspire others to create.`,
  slug: "diy",
  ideas: [
    { id: 13, title: "Recreating Pinterest DIYs", description: "Attempt to recreate popular DIY projects from Pinterest", tags: ["diy", "pinterest", "crafts"] },
    { id: 15, title: "Room Makeover on a Budget", description: "Transform a room without spending a lot of money", tags: ["diy", "budget", "decor"] },
    { id: 28, title: "Making My Own Clothes", description: "Design and create your own clothing from scratch", tags: ["sewing", "fashion", "diy"] },
    { id: 32, title: "Building a Fort Challenge", description: "Create the ultimate blanket fort or treehouse", tags: ["building", "fort", "fun"] },
    { id: 47, title: "Making Furniture From Scratch", description: "Build a piece of furniture without using a kit", tags: ["woodworking", "furniture", "diy"] },
    { id: 70, title: "Building a Greenhouse", description: "Construct a small greenhouse for growing plants", tags: ["greenhouse", "gardening", "diy"] },
    { id: 78, title: "Building the Ultimate Pillow Fort", description: "Create an elaborate fort using pillows and blankets", tags: ["fort", "building", "fun"] },
    { id: 80, title: "Making My Own Board Game", description: "Design and create an original board game", tags: ["boardgame", "design", "creative"] },
    { id: 84, title: "Making My Own Instruments", description: "Build musical instruments using household materials", tags: ["instruments", "music", "diy"] },
